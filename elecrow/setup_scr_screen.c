...
void setup_scr_screen(lv_ui *ui){
  ...
  lv_obj_set_pos(ui->screen_img_10, 29, 23);
  ...
  lv_obj_set_pos(ui->screen_img_9, 27, 20);
  ...
  lv_obj_set_pos(ui->screen_img_8, 27, 20);
  ...
  lv_obj_set_pos(ui->screen_img_7, 27, 20);
  ...
  lv_obj_set_size(ui->screen_label_1, 480, 320);
  ...
  lv_obj_set_pos(ui->screen_label_2, 20, 19);
  lv_obj_set_size(ui->screen_label_2, 441, 284);
  ...
  lv_obj_set_pos(ui->screen_img_1, 32, 29);
  ...
  lv_obj_set_pos(ui->screen_label_3, 26, 172);
  lv_obj_set_size(ui->screen_label_3, 160, 36);
  ...
  lv_obj_set_pos(ui->screen_label_4, 102, 257);
  lv_obj_set_size(ui->screen_label_4, 46, 27);
  ...
  lv_obj_set_pos(ui->screen_img_2, 26, 220);
  lv_obj_set_size(ui->screen_img_2, 84, 67);
  ...
  lv_obj_set_pos(ui->screen_label_5, 104, 220);
  lv_obj_set_size(ui->screen_label_5, 44, 28);
  ...
  lv_obj_set_pos(ui->screen_label_6, 225, 24);
  lv_obj_set_size(ui->screen_label_6, 225, 64);
  ...
  lv_obj_set_pos(ui->screen_img_3, 318, 275);
  ...
  lv_obj_set_pos(ui->screen_label_7, 345, 277);
  lv_obj_set_size(ui->screen_label_7, 111, 23);
  ...
  lv_obj_set_pos(ui->screen_label_8, 201, 100);
  lv_obj_set_size(ui->screen_label_8, 80, 24);
  ...
  lv_obj_set_pos(ui->screen_img_4, 147, 257);
  ...
  lv_obj_set_pos(ui->screen_line_1, 338, 140);
  lv_obj_set_size(ui->screen_line_1, 15, 116);
  ...
  static lv_point_t screen_line_1[] ={{0, 0},{0, 107},};
  lv_line_set_points(ui->screen_line_1,screen_line_1,2);

  //Write codes screen_label_9
  ui->screen_label_9 = lv_label_create(ui->screen);
  lv_obj_set_pos(ui->screen_label_9, 279, 101);
  lv_obj_set_size(ui->screen_label_9, 182, 25);
  ...
  lv_obj_set_pos(ui->screen_label_10, 222, 140);
  lv_obj_set_size(ui->screen_label_10, 81, 19);
  ...
  lv_obj_set_pos(ui->screen_label_11, 354, 140);
  lv_obj_set_size(ui->screen_label_11, 92, 17);
  ...
  lv_obj_set_pos(ui->screen_img_5, 228, 180);
  ...
  lv_obj_set_pos(ui->screen_img_6, 360, 180);
  ...
  lv_obj_set_pos(ui->screen_label_12, 146, 220);
  lv_obj_set_size(ui->screen_label_12, 40, 28);
  ...
  lv_obj_set_pos(ui->screen_label_13, 210, 242);
  lv_obj_set_size(ui->screen_label_13, 113, 23);
  ...
  lv_obj_set_pos(ui->screen_label_14, 339, 245);
  lv_obj_set_size(ui->screen_label_14, 117, 20);
